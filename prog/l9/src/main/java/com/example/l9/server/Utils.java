...
import com.example.l9.common.collection.Coordinates;
import com.example.l9.common.collection.Location;
import com.example.l9.common.collection.Movie;
import com.example.l9.common.collection.Person;
import com.example.l9.common.collection.Country;
import com.example.l9.common.collection.MovieGenre;
import com.example.l9.common.collection.MpaaRating;
...
public class Utils {
    ...
    public static Map<String, Movie> getMoviesFromDB(Connection conn) throws Exception {
        PreparedStatement s;
        s = conn.prepareStatement(
            "SELECT key, name, coords_id, creation_date, oscars_count, usa_box_office, genre, mpaa_rating, id, username FROM movies;"
        );
        ResultSet res = s.executeQuery();
